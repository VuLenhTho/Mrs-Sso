    ...
    <div class="content-body" style="background-color: white">
        ...
        <div class="row" style="color: #000000">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<c:url value="/admin/report"/>" id="formSubmit" method="get">
                            <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-validation">
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label" for="moneyFromSale">Tổng tiền thu
                                                    về:</label>
                                                <div class="col-lg-10">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label" for="interestMoney">Tổng tiền
                                                    lãi:
                                                </label>
                                                <div class="col-lg-10">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-2 col-form-label" for="importMoney">Tiền nhập:
                                                </label>
                                                <div class="col-lg-10">
