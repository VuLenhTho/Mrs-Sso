        ...
        var e = "metisMenu", s = n.fn[e], a = {
            ...
            return s.init = function () {
                ...
                n(this.element).find(t.parentTrigger + "." + t.activeClass).has(t.subMenu).children(t.subMenu).attr("aria-expanded", !0).addClass(t.collapseClass + " " + t.collapseInClass), n(this.element).find(t.parentTrigger).not("." + t.activeClass).has(t.subMenu).children(t.subMenu).attr("aria-expanded", !1).addClass(t.collapseClass), n(this.element).find(t.parentTrigger).has(t.subMenu).children(t.triggerElement).on(r.CLICK_DATA_API, function (i) {
                    var s = n(this), a = s.parent(t.parentTrigger),
                        r = a.siblings(t.parentTrigger).children(t.triggerElement), o = a.children(t.subMenu);
                ...
                return this.each(function () {
                    var s = n(this), r = s.data("metisMenu"),
...
!function (i) {
    ...
    function s(i) {
        var t = i.data("settings") || {direction: "left", speed: 50}, e = i.children().first(),
    ...
    function c(t, e, s) {
        ...
        i.get(t, function (t) {
            ...
            r.find("item").each(function () {
                var t = i(this), e = {title: t.find("title").text(), link: t.find("link").text()},
    ...
    var o = function () {
        var i = document.createElement("p").style, t = ["ms", "O", "Moz", "Webkit"];
        ...
        init: function (t) {
            return t = jQuery.extend({
                ...
                var e = jQuery(this), s = e.wrap('<div class="mask"></div>');
            ...
            if ("reset" === s) a.html(e), l(a, !0); else if ("swap" === s) {
                var o, d, h, f;
                if (window.console, a.children("li").length < 1) a.html(e), a.css(c.direction, "0"), l(a, !0); else if (c.duplicate === !0) {
